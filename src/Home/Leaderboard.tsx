...
const headCells = [
  { id: "position", numberic: true, label: "Position" },
  ...
  { id: "winPercentage", numberic: true, label: "Win Percentage" },
  { id: "gamesPlayed", numberic: true, label: "Games Played" },
  { id: "eloScore", numberic: true, label: "Elo Score" },
...
export function Leaderboard(props: { game: Game[] }) {
